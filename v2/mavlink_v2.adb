...
package body Mavlink_v2 is
   ...
   begin
      ...
      Self.Key := Sha256.Initial_Context;
      Sha256.Update (Self.Key, Sha256.Data (Key));
   ...
   is
      Local_Id : constant Msg_Id with Import,
        Address => Self.Income_Buffer
          (Self.Income_Buffer'First +
             Message_Id_Position_In_Buffer)'Address;

   begin
      return Local_Id and 16#FF_FFFF#;
   end Get_Message_Id;
